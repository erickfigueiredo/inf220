<template>
  <div v-if="type != 'none'" class="flex w-full mb-4 mt-4">
    <div
      class="inline-flex max-w-sm w-full bg-white shadow-md rounded-lg overflow-hidden ml-0"
    >
      <div :class="bgColor" class="flex justify-center items-center w-12">
        <svg
          v-if="type == 'success'"
        ...
        <svg
          v-else-if="type == 'info' || type == 'warning'"
          class="h-6 w-6 fill-current text-white"
          viewBox="0 0 40 40"
          xmlns="http://www.w3.org/2000/svg"
        >
      ...
      <div class="-mx-3 py-2 px-4">
        <div class="mx-3">
          <span :class="fontColor" class="font-semibold">{{ title }}</span>
