  ...
  <div class="flex justify-center items-center h-screen bg-gray-300 px-6">
    <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md my-10">
      ...
      <form class="mt-4" @submit.prevent="go">
        <div class="mb-4 mt-10">
          ...
          <input
            ...
            required
            v-model="email"
            class="text-sm sm:text-sm w-full border rounded text-gray-600 placeholder-gray-700 focus:border-blue-600 focus:outline-none py-2 px-4"
          />
        </div>
        ...
        <div class="mb-1">
          ...
          <input
            ...
            required
            v-model="password"
            class="text-sm sm:text-sm w-full border rounded text-gray-600 placeholder-gray-500 focus:border-blue-600 focus:outline-none py-2 px-4"
          />
        </div>
      ...
      <p class="text-center text-gray-500 text-xs mt-10">
        &copy;2020 El Comprador | All rights reserved.
      </p>
    </div>
  </div>
</template>
